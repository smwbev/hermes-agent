...
CANDIDATE = '192fdf397a4f734bf281a619fdf04bd91e1cc4f0'
BASE = '9fe737aef2dd18a351dff3c4de608d63879a6524'
FILES = [
    'tests/hermes_cli/test_pip_install_detection.py',
    'tests/hermes_cli/test_ensure_hermes_home_uid.py',
    'tests/test_scratch_dir.py',
    'tests/hermes_cli/test_config_provider_id_string.py',
    'tests/hermes_cli/test_config_yaml_comment_preservation.py',
    ...
    'tests/hermes_cli/test_platform_plugin_env_injection.py',
    'tests/hermes_platform/test_facts.py',
    'tests/hermes_platform/test_products.py',
    'tests/hermes_platform/test_import_hygiene.py',
...
manifest = dict(candidate_sha=actual, base_sha=BASE, task_id='t_f7e0eb08',
    source_implementation_run_id=73, github_run_id=os.environ.get('GITHUB_RUN_ID'),
